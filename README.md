...
- [ ] Mention two parts of Express that you learned about this week.
    express allows us to use middleware to modify the request and response objects before the response is sent back to the user.
    express also allows us to use routes. routes let us select which request handler function is executed.

- [ ] Describe Middleware?
    middleware is used to modify the request and response objects before the response is sent back to the user.
...
- [ ] How can we partition our application into sub-applications?
    we can seperate the app into routers where each router can have its own middleware and routing
